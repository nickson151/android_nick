...
class seleccion_escenario_3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_seleccion_escenario3)
        ...
        flecha_derecha.setOnClickListener{
            val intent = Intent(this, park_1::class.java)  // colocar a donde llega derecha Main D
            startActivity(intent)
        }
